...
function MapControl(){
  ...
  this.geoVillage = {};
	...
	this.LoadVillage = function(county){
    $.ajax({
  ...
  this.GenAlertContent = function(feature){
    var content = "";
  ...
  this.ToggleSatellite = function(useSatellite){
    if(useSatellite){
  ...
  this.UpdateMapRain = function(rainData){
  ...
  this.UpdateMapWaterLevel = function(preDataHash, waterLevelData){
  ...
  this.UpdateMapReservoir = function(reservoirData){
  ...
  this.UpdateMapAlert = function(alertData, t){
  ...
  this.UpdateMapTyphoon = function(typhoonData){
  ...
  this.ClearMapWaterLevel = function(){
  ...
  this.ClearMapReservoir = function(){
